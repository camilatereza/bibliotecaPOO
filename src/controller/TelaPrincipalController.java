...
public class TelaPrincipalController implements Initializable {
	...
	// Aqui tem a declara��o dos atributos que est�o no XML e que ser�o modificados
	// ou fazem alguma a��o
	...
	// Main. -> Para chamar o metodo de mudar de tela que est� l�(l� = classe
	// chamada Main)
	...
	// Ja vem com a implementa��o do inicializable,quando a tela e chamada ele ja e
	// ativado
