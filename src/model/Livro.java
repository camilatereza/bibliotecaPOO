...
//		this.quantidadeDeLivros = 0;
	...
	//o codigo � numerico e usa os enum para gerar um codigo diferente para cada livro;
	...
	//os dois ultimos numeros antes da virgula indicam o ano de lan�amento do livro
	// por fim o numero ap�s a virgula � um randomico para diferenciar todos os livros
