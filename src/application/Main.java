...
public class Main extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		Main.stage = stage;//aqui eu setei o stage estatico para receber o stage que eu passei como parameto, 
		//fica mais facil de trabalhar desse jeito
		//Parent -> é um tipo de Pane ou stage que ja vem com children, esses nomes(Parent,children) e proprio do XML 
	...
	public static void MudarTela (String tela){
		switch(tela) {
			//Switch simples, para setar a cena do stage estatico, adaptado nos Controllers de cada FXML
			case "login":
				stage.setScene(login);
				break;
			case "principal":
