...
public class Main extends Application {
	...
	public void start(Stage stage) throws Exception {
		// Start(Stage stage)-> e o que inicia a aplica��o
		...
		// Parent -> � um tipo de Pane ou stage que ja vem com children, esses
		...
		// Aqui criamos varias telas que v�o ser utilizadas no decorrer do app
	...
	// isso eu n�o sei para que serve,mas veio junto ent�o so aceitei
